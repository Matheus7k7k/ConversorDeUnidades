...
void menuConversorDeComprimento(){
  int unidadeOrigem = 0, unidadeDestino = 0, sair = 0;
    ...
    while (!sair) {
        ...
        if (valorEmMetros == -1) {
            printf("Erro na conversao da unidade de origem.\n");
            continue;
        }

        valorConvertido = converterDeMetros(valorEmMetros, unidadeDestino);
        if (valorConvertido == -1) {
            printf("Erro na conversao para a unidade de destino.\n");
            continue;
        }
...
void menuConversorDeMassa()
{
  ...
  do
  {
    ...
    {
    case 1:
      printf("Informe o valor em gramas que serao convertido a quilos  \n");
    ...
    case 3:
      printf("Informe o valor em quilos que serao convertidos a toneladas \n");
      scanf("%f", &valorConversao);
      resultadoConversao = valorConversao / 1000;
...
void menuConversorDeVolume()
{
  ...
  do
  {
    ...
    case 4:
      ...
      printf("%.2f mililitros  = %.2f metros cubicos \n", valor, resultado);
      break;
